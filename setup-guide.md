...
* <span style="color:blue">**URL MIME Types**</span>: Set the MIME types of each URL. It can be using URL Extension, HLS or DASH. Only using URL Extension or HLS is supported for macOS. URL Extension is set by default.
